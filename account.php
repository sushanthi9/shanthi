...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  if(count($errors)==0){
    ...
    if($updatepassword==false){
      $account_update_query = "UPDATE accounts SET name=?,email=? WHERE id=?";
    ...
    //update accounts table with new password
      ...
      $account_update_query = "UPDATE accounts SET name=?,email=?,password=? WHERE id=?";
          ...
          <div class="col-md-6">
              ...
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <select name="state" class="form-control" id="state" placeholder="state or province">
                    <!-- using java script end points to for java script to read data from database> -->
            ...
            <div class="form-group">
              ...
              <select id="country" class="form-control" name="country">
                <?php
                 //moved up to use for sub regions
                 //$default_country_code = "AU";
                  if($country){
                    $default_country_code = $country;
                  }
